...
TESTFILE_HAP_FOR = os.path.join(TESTFILES_PATH, 'mtDNA.haplotypes.forensic.txt')
# test file with haplotypes in nomenclature population genetics
TESTFILE_HAP_POP = os.path.join(TESTFILES_PATH, 'mtDNA.haplotypes.population.txt')
